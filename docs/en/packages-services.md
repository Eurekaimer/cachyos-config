...
Counts below come from the committed manifests, last refreshed on `2026-09-11`:

| Source | Count | Manifest |
|---|---:|---|
| CachyOS/Arch repository packages | 250 | `packages/pacman-explicit.txt` |
| AUR/external packages | 21 | `packages/aur-explicit.txt` |
| Rustup toolchains | 1 | `packages/rustup-toolchains.txt` |
| Bun global packages | 3 | `packages/bun-global.txt` |
| Enabled system services | 31 | `packages/system-services.txt` |
| Enabled user services | 8 | `packages/user-services.txt` |
