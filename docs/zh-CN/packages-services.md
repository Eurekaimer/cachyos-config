...
以下数量取自已提交的清单，最近一次刷新于 `2026-09-11`：

| 来源 | 数量 | 清单 |
|---|---:|---|
| CachyOS/Arch 仓库软件包 | 250 | `packages/pacman-explicit.txt` |
| AUR/外部软件包 | 21 | `packages/aur-explicit.txt` |
| Rustup 工具链 | 1 | `packages/rustup-toolchains.txt` |
| Bun 全局软件包 | 3 | `packages/bun-global.txt` |
| 已启用系统服务 | 31 | `packages/system-services.txt` |
| 已启用用户服务 | 8 | `packages/user-services.txt` |
